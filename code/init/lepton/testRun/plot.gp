...
set xlabel "q_0" 0.000000,0.000000  font ""
set x2label "" 0.000000,0.000000  font ""
set xrange [ * : * ] noreverse nowriteback  # (currently [-10.0000:10.0000] )
set x2range [ * : * ] noreverse nowriteback  # (currently [-10.0000:10.0000] )
set ylabel "Xsection [mub]" 0.000000,0.000000  font ""
...
plot "fort.12" u 2:3 w l t 'no {/Symbol G}_{{/Symbol g}N}'
replot "fort.12.old" u 2:3 w l t 'with {/Symbol G}_{{/Symbol g}N}'

set output 'pGamma.eps'
