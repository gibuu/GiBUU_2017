c===================================================================
c This is a modified version of original PYTHIA-PYMASS (v6.419)
c
c * mass of vector mesons done by module VMMassPythia
c===================================================================
...
C...(either in m or in m^2).
     ...
     &    ATAN(2D0*PMAS(KC,3)/PMAS(KC,2)))
          ...
          case(113,213,223,333)
            pymass = VM_Mass(kfa)       ! rho,omega,phi
          case(1114,2114,2214,2224)
            pymass = Delta_Mass()       ! Delta(-,0,+,++)
          end select
