c===================================================================
c This is a modified version of original PYTHIA-PYSIGH (v6.419)
c
c * here the cut
c     SH=MAX(1D0,TAU*VINT(2))
c   is relaxed to
c     SH=MAX(1D-2,TAU*VINT(2))
c * epsilon ic calculated as for HERMES (better flux definition)
c===================================================================
...
C...Derive kinematical quantities
      ...
      ENDIF
!      SH=MAX(1D0,TAU*VINT(2))   ! [GiBUU]
      SH=MAX(1D-2,TAU*VINT(2))   ! [GiBUU]
      SQM3=VINT(63)
      SQM4=VINT(64)
      RM3=SQM3/SH
      RM4=SQM4/SH
...
!            FRACLT=1D0/(1D0+XY**2/2D0/(1D0-XY)*         ! [GiBUU]
!     &      (1D0-2D0*BEAMAS**2/Q2GA))                   ! [GiBUU]
            if (xy.gt.0d0) then
