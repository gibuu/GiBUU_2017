program test
  ...
  subroutine testEtaDelta
    use IDTABLE
    use mediumDefinition
    use particleDefinition
    use particleProperties
    use etaDelta_resonance
...
!       plab = 0.5*exp( (log(500.)-log(0.5))*i/300. )
       ...
       call etaDelta(srts,teilchenIN,mediumATcollision,momentumLRF,teilchenOUT,sigmaTot,sigmaElast,.true.,2.2,.true.)
